...
var resizePizzas = function(size) {
  ...
  function determineDx (elem, size) {
    ...
    //console.log("newsize: "+newsize +"; "+"oldsize: "+oldsize+"; "+"windowwidth"+windowwidth+"; "+"dx: "+dx);
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  // reduced the number of pizzas to 35 because we do not see all 200 pizzas all the time.
  for (var i = 0; i < 35; i++) {
